...
if __name__ == '__main__':
    ...
    convert_pb('HW2/FaceClustering/app/src/main/assets/age_gender_ethnicity_224_deep-03-0.13-0.97-0.88.pb', quantize=True)
    # convert_h5('app/src/main/assets/emotions_mobilenet.h5', quantize=True)
