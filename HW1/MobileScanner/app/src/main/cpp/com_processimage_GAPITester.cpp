#include <com_processimage_GAPITester.h>
...
JNIEXPORT jlong JNICALL Java_com_processimage_GAPITester_gapiInit
        (JNIEnv *, jclass){
    LOGD("Java_com_processimage_GAPITester_gapiInit");
    jlong result = (jlong)new GApiTester();
    LOGD("Java_com_processimage_GAPITester_gapiInit end");
    return result;
}

JNIEXPORT void JNICALL Java_com_processimage_GAPITester_gapiTest
  (JNIEnv *, jclass, jlong thiz, jlong addrMatIn, jlong addrMatOut){
    LOGD("Java_com_processimage_GAPITester_gapiTest");
    ...
    LOGD("Java_com_processimage_GAPITester_gapiTest end total time: %d ms",int_ms);
}
